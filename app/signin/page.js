...
export default function Signin() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // Google sign-in will also trigger the user effect above
    } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden flex items-center justify-center p-4">
      ...
      >
        ...
        {/* Success message */}
        {user && (
          <div className="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-xl text-center animate-fadeIn mb-6">
            <div className="flex items-center justify-center">
              <div className="w-2 h-2 bg-green-500 rounded-full mr-3"></div>
              🎉 Signin successful! Welcome, {user.user.email}
            </div>
          </div>
        )}
